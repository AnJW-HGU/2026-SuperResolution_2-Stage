...
yml_path = 'Part1\\BasicSR\\experiments\\SRGAN_128\\train_ESRGAN_x4.yml'
...
pth_path = 'Part1\\BasicSR\\experiments\\SRGAN_128\\models\\net_g_12000.pth'
...
output_train_base_path = 'dataset/SR_srgan/output/train'  # High-resolution image output folder
output_test_base_path = 'dataset/SR_srgan/output/test'  # High-resolution image output folder
